...
(async () => {
  ...
  await t("M-03: allowlist exists and contains only web assets", () => {
    if (!/PUBLIC_WEB_FILES = new Set\(\["\/index.html", "\/styles.css", "\/script.js", "\/clipme-cut-to-face.js", "\/clipme-active-speaker.js", "\/build\/icon.png"\]\)/.test(serverSrc)) {
  ...
  // Allowed web assets
  for (const p of ["/", "/index.html", "/styles.css", "/script.js", "/clipme-cut-to-face.js", "/clipme-active-speaker.js"]) {
